    ...
    <div class="row">
        <div class="col-md-3">
            <div class="list-group">
                ...
                <a href="health_details.php" class="list-group-item">Health details</a>
                <a href="package.php" class="list-group-item">Package details</a>
                <a href="payment.php" class="list-group-item">Payments</a>
            </div>
            <hr>
            <div class="list-group">
<a href="trainer2.php" class="list-group-item active">Trainer</a>
<a href="trainer1.php" class="list-group-item active">Add health Details</a>
